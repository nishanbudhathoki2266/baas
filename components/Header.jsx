    ...
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
      ...
      <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm">
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          fill="currentColor"
          className="hidden md:inline-flex h-8 bg-[#5bccf6] rounded-full text-white p-2 cursor-pointer md:mx-2"
        >
          <path
            fillRule="evenodd"
      ...
      {/* Right */}
      <div className="flex gap-2 items-center justify-end text-gray-700 cursor-pointer">
        ...
        <div className="flex ml-2 border-2 p-2 rounded-full items-center cursor-pointer">
          {/* Menu Icon */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
      ...
      {searchInput && (
        <div className="flex flex-col col-span-3 mx-auto">
          ...
          <div className="flex items-center">
            ...
            <button className="flex-grow text-maroon" onClick={handleSearch}>
              Search
            </button>
          </div>
        </div>
